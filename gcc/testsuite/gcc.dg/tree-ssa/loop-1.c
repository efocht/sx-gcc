...
/* SX will put address of foo in a symbol in prefix of function xxx, and load
   it only once. as this testcase only calls foo, we will just count bsics,
   i.e. function calls */

/* { dg-final { scan-assembler-times "foo" 5 { xfail hppa*-*-* ia64*-*-* sh*-*-* cris-*-* m68k-*-* sx*-*-* } } } */
...
/* { dg-final { scan-assembler-times "bsic" 5 { target sx*-*-* } } } */
